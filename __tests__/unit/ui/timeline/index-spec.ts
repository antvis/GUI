...
describe('timeline layout cell', () => {
  test('left', () => {
    ...
    expect(cellAxis?.backgroundVerticalCenter - getVerticalCenter(speedControl)).toBeCloseTo(0, 4);
    expect(cellAxis?.backgroundVerticalCenter - getVerticalCenter(playBtn)).toBeCloseTo(0, 4);
    expect(cellAxis?.backgroundVerticalCenter - getVerticalCenter(prevBtn)).toBeCloseTo(0, 4);
    expect(cellAxis?.backgroundVerticalCenter - getVerticalCenter(nextBtn)).toBeCloseTo(0, 4);
    expect(cellAxis?.backgroundVerticalCenter - getVerticalCenter(singleTimeCheckbox)).toBeCloseTo(0, 4);
  ...
  test('normal column', () => {
    ...
    expect(singleTimeCheckbox.getBounds().max[0]).toBe(510);
  });
});
...
describe('timeline slider', () => {
  ...
  test('normal column', () => {
    ...
    expect(getVerticalCenter(speedControl) - getVerticalCenter(nextBtn)).toBeCloseTo(0, 4);
    expect(getVerticalCenter(speedControl) - getVerticalCenter(singleTimeCheckbox)).toBeCloseTo(0, 4);
    expect(playBtn.getBounds().center[0] - sliderAxis.sliderBackground.getBounds().center[0]).toBeCloseTo(0, 4);
  });
});
