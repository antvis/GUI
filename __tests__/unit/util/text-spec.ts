...
describe('text', () => {
  test('measureTextWidth', async () => {
    expect(measureTextWidth('test text', FONT_STYLE)).toBeCloseTo(45, -1);
  ...
  test('new font measure', () => {
    expect(measureTextWidth('test text', NEW_FONT_STYLE)).toBeCloseTo(90, -1);
  ...
  test('getEllipsisText', async () => {
    ...
    expect(getEllipsisText(testText, 20, FONT_STYLE)).toBe('t...');
  ...
  test('new font ellipsis', async () => {
    ...
    expect(getEllipsisText(testText, 40, NEW_FONT_STYLE)).toBe('t...');
