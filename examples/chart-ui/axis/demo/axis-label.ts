...
const data = ['Design', 'Development', 'Marketing', 'Users', 'Language', 'Technology', 'Support', 'Sales', 'UX', 'Test'];
...
window.ConfigPanel(linear, 'Linear axis label', {
  ...
  'label.minLength': { label: '最小长度', value: 10, type: 'number', step: 2, range: [14, 40] },
  'label.maxLength': { label: '最大长度', value: 160, type: 'number', step: 2, range: [40, 4000] },
  'label.tickPadding': { label: '标签与刻度线距离', value: 4, type: 'number', step: 1, range: [0, 10], },
