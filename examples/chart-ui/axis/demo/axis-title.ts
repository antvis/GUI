...
window.ConfigPanel(linear, 'Linear axis title', {
  ...
  'title.style.textAlign': { label: '轴标题对齐方式', value: 'auto', options: [{ name: 'auto', value: undefined }, 'start', 'center', 'end'] },
  'title.style.textBaseline': { label: '轴标题垂直对齐方式', value: 'auto', options: [{ name: 'auto', value: undefined }, 'top', 'middle', 'top'] },
...
window.ConfigPanel(arc, 'Arc axis title', {
  'title.style.fill': { label: '轴标题填充色', value: '#416180', type: 'color' },
  'title.style.fontSize': { label: '轴标题字体大小', value: 10, type: 'number', step: 2, range: [10, 30], },
  'title.style.textAlign': { label: '轴标题对齐方式', value: 'auto', options: [{ name: 'auto', value: undefined }, 'start', 'center', 'end'] },
  'title.style.textBaseline': { label: '轴标题垂直对齐方式', value: 'auto', options: [{ name: 'auto', value: undefined }, 'top', 'middle', 'top'] },
